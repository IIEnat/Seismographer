...
def main():
    ...
    stations: List[StationSpec] = [
        StationSpec(args.ports[0], "XX", "JINJ1", "", "BHZ", -31.3447, 115.8923, "sine"),
        StationSpec(args.ports[1], "XX", "JINJ2", "", "BHZ", -31.3752, 115.9231, "square"),
        StationSpec(args.ports[2], "XX", "JINJ3", "", "BHZ", -31.3433, 115.9667, "triangle"),
    ]
